#############################################################################
########Neural Networks - Predicting the fuel consumption of the vehicles####
##########R program to build, train and test neural networks#################
##Ref: 'Neural' Network with R by Giuseppe Ciaburro and Balaji Venkateswaran#
#############################################################################
install.packages("neuralnet")
library("neuralnet")
install.packages("ISLR")
library("ISLR")
data = Auto # open source data from 'ISLR' package
View(data)
...
MSE.lm
#MSE.net <<< MSE.lm - NN is better fit than LM
par(mfrow=c(1,2))
plot(test_data$mpg,predict_net_test$net.result,col='black',main='Real vs predicted for neural net', pch= abline(0,1,lwd=5))
